...
def create_scheduler(train_config, optimizer, len_train_loader):
    steps = train_config['step_coeff'] * len_train_loader
    ...
    if train_config['scheduler'] == 'cyclic':
        scheduler = torch.optim.lr_scheduler.CyclicLR(optimizer,
                                                      ...
                                                      verbose=False)  # set cycle_momentum=False for ADAM optimizer
    elif train_config['scheduler'] == 'cosine_annealing':
        scheduler = optim.lr_scheduler.CosineAnnealingLR(optimizer, T_max=train_config['num_epochs'], verbose=False)
